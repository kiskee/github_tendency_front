        ...
        <div>
          ...
          <div className="grid gap-4">
            {data.repositories.map(repo => (
              <div key={repo.githubId} className="bg-gray-900/50 backdrop-blur-xl rounded-xl p-4 sm:p-5 border border-orange-900/30 hover:border-orange-700/60 transition-all duration-300 hover:shadow-lg hover:shadow-orange-600/15">
                <a href={repo.url} target="_blank" rel="noopener noreferrer" className="text-orange-500 font-medium hover:underline text-base sm:text-lg truncate block">
                  {repo.fullName}
                </a>
